# 🐾 Proyecto desarrollado por el equipo de frontend para Safari-Kids🦁
...
* **Alojamiento de Repositorio:** [GitHub](https://github.com/)
* **Estilos:** CSS3 con enfoque en **Experiencia de Usuario (UI/UX)** infantil.

---

## 🚀 Guía de Instalación y Ejecución
Para ejecutar este proyecto en tu entorno local, sigue estos pasos desde tu **Git Bash**:

1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/SofiaMendoza-code/safari-kids.git](https://github.com/SofiaMendoza-code/safari-kids.git)